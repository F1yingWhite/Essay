...
## DSMIL分类
该文章的主要创新在于设计了一个新颖的聚类方法g和特征提取方法f的学习.具体来说，我们提出了DSMIL，它由一个掩码非局部块和一个用于特征聚合的最大池化块组成，输入实例嵌入由自监督对比学习得到。此外，DSMIL 使用金字塔策略结合了多尺度嵌入，从而确保了WSI中对图像块注意力的局部约束。![[DeepLearning/ZJU/pathology+CT/attachments/Pasted image 20240706213310.png]]
### MIL Aggregator with Masked Non-Local Operation

![[DeepLearning/ZJU/pathology+CT/attachments/Pasted image 20240706214934.png]]
